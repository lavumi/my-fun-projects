...
export function wasm_bindgen__convert__closures__invoke0_mut__h748ff12aabb1f666(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h489a46a129610aeb(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__he735efe11a75f3f0(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h436746b1c27b1863(a: number, b: number, c: number): void;
