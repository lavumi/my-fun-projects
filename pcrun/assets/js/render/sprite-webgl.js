var TextureUtil = {
    ...
    textureList : [
        'assets/prcn_data/109631.png',
        'assets/prcn_data/ground2.png',
        'assets/prcn_data/tree.png',
        'assets/prcn_data/bg.png',
        'assets/prcn_data/obstacle.png',
        'assets/prcn_data/optionUI.png'
    ],
    ...
    getTexture : function( textureName ){
        return this._glTexture["assets/prcn_data/"+textureName];
    }
};
